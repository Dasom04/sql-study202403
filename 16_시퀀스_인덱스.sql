...
CREAT SEQUENCE dept2_seq
    START WITH 1 -- 시작값 (기본값은 증가할 때 최소값, 감소할 때 최대값)
    INCREMENT BY 1 -- 증가값 (양수만 증가, 음수면 감소, 기본값 1 (안에 숫자 만큼 증가))
    MAXVALUE 10 -- 최대값 (기본값은 증가 할때 1027, 감소일 때 -1)
